 ...
 *  @generated
 */
package com.ganqiang.swift.net.thrift;
...
@Generated(value = "Autogenerated by Thrift Compiler (1.0.0-dev)", date = "2014-4-16")
public class Job implements org.apache.thrift.TBase<Job, Job._Fields>, java.io.Serializable, Cloneable, Comparable<Job> {
  ...
  private static final _Fields optionals[] = {_Fields.INTERVAL,_Fields.START_TIME,_Fields.HTTP_PROXYS,_Fields.IN_USE_PROXY,_Fields.OUT_USE_PROXY,_Fields.IN_SEEDS,_Fields.OUT_SEEDS,_Fields.IN_ISDOWNLOAD,_Fields.OUT_ISDOWNLOAD,_Fields.JS_SUPPORT,_Fields.IS_CASCADE,_Fields.DEPTH,_Fields.IN_DELAY,_Fields.OUT_DELAY};
  ...
  public int hashCode() {
    ...
    boolean present_httpProxys = true && (isSetHttpProxys());
    list.add(present_httpProxys);
    if (present_httpProxys)
      list.add(httpProxys);

    boolean present_inUseProxy = true && (isSetInUseProxy());
    list.add(present_inUseProxy);
    if (present_inUseProxy)
      list.add(inUseProxy);

    boolean present_outUseProxy = true && (isSetOutUseProxy());
    list.add(present_outUseProxy);
    if (present_outUseProxy)
      list.add(outUseProxy);

    boolean present_inSeeds = true && (isSetInSeeds());
    list.add(present_inSeeds);
    if (present_inSeeds)
      list.add(inSeeds);

    boolean present_outSeeds = true && (isSetOutSeeds());
    list.add(present_outSeeds);
    if (present_outSeeds)
      list.add(outSeeds);

    boolean present_inIsdownload = true && (isSetInIsdownload());
    list.add(present_inIsdownload);
    if (present_inIsdownload)
      list.add(inIsdownload);

    boolean present_outIsdownload = true && (isSetOutIsdownload());
    list.add(present_outIsdownload);
    if (present_outIsdownload)
      list.add(outIsdownload);

    boolean present_jsSupport = true && (isSetJsSupport());
    list.add(present_jsSupport);
    if (present_jsSupport)
      list.add(jsSupport);

    boolean present_isCascade = true && (isSetIsCascade());
    list.add(present_isCascade);
    if (present_isCascade)
      list.add(isCascade);
    ...
    boolean present_inDelay = true && (isSetInDelay());
    list.add(present_inDelay);
    if (present_inDelay)
      list.add(inDelay);

    boolean present_outDelay = true && (isSetOutDelay());
    list.add(present_outDelay);
    if (present_outDelay)
      list.add(outDelay);
