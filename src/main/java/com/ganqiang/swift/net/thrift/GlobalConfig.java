...
public class GlobalConfig implements org.apache.thrift.TBase<GlobalConfig, GlobalConfig._Fields>, java.io.Serializable, Cloneable, Comparable<GlobalConfig> {
  ...
  private static final _Fields optionals[] = {_Fields.PORT,_Fields.SERVER,_Fields.PROTOCAL,_Fields.THREAD_NUM,_Fields.HTTP_PROXYS,_Fields.DISK,_Fields.IS_SYNC,_Fields.SYNC_DOMAIN,_Fields.INDEX,_Fields.DB_DRIVER,_Fields.DB_URL,_Fields.DB_USERNAME,_Fields.DB_PASSWORD,_Fields.DB_POOL_SIZE};
  ...
  public int hashCode() {
    ...
    boolean present_protocal = true && (isSetProtocal());
    list.add(present_protocal);
    if (present_protocal)
      list.add(protocal);
    ...
    boolean present_isSync = true && (isSetIsSync());
    list.add(present_isSync);
    if (present_isSync)
      list.add(isSync);

    boolean present_syncDomain = true && (isSetSyncDomain());
    list.add(present_syncDomain);
    if (present_syncDomain)
      list.add(syncDomain);
    ...
    boolean present_dbDriver = true && (isSetDbDriver());
    list.add(present_dbDriver);
    if (present_dbDriver)
      list.add(dbDriver);

    boolean present_dbUrl = true && (isSetDbUrl());
    list.add(present_dbUrl);
    if (present_dbUrl)
      list.add(dbUrl);

    boolean present_dbUsername = true && (isSetDbUsername());
    list.add(present_dbUsername);
    if (present_dbUsername)
      list.add(dbUsername);

    boolean present_dbPassword = true && (isSetDbPassword());
    list.add(present_dbPassword);
    if (present_dbPassword)
      list.add(dbPassword);

    boolean present_dbPoolSize = true && (isSetDbPoolSize());
    list.add(present_dbPoolSize);
    if (present_dbPoolSize)
      list.add(dbPoolSize);
