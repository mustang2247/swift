...
![Image text](https://github.com/ganqiang1983/swift/blob/master/logo.jpg)
  ...
  3.默认每次抓取采用轮询代理和User-Agent的方式，并且支持每两次抓取时的时间间隔，让抓取更加人性化 <br /> 
  4.支持xml可配置，内置了一些网站（注：由于某些网站内容会随时改变，具体的实现类也必须要跟着改）<br /> 
  5.多插件式继承：
  ...
  5.5与Thrift继承：通过thrift接口接受swift-monitor发来的指令，还可以通过thrift接口将<br /> 
                                    爬虫数据进行转发。<br />
  -----------
